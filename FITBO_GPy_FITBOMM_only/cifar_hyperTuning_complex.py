...
set_random_seed(1)
initial_num = 3
x_ob1 = np.array([16, 256, 0.1, 0.1, 0.7, 0.0001])
...
def cifar_fitbo_wrapper(batch_size, heuristic = "cl-min"):
    ...
    if batch_size == 1: # Sequential
        ...
        for seed in range(seed_size):
            ...
            bayes_opt = Bayes_opt(cifar_utils.cifar_cnn_fitbo, fitbo_lb, fitbo_ub, var_noise = 0)
